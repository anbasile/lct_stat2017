...
- Operationalization :: n-gram language modeling as predictor for entropy scores computed over emotional reactions
- Prediction :: sets of word/character n-grams will correlate with entropy scores
